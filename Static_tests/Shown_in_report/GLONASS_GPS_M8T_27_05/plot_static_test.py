# parameters
csv_file = 'test_nmea_27_05_clean.txt'		#Name of input file
...
outlier_threshold = 0.			#Threshold i meters. if == 0, no outliers rm 
...
map_plot_solution = 6			#Choose solution plotted in the map plot
histogram_plot_solution = 6		#Choose solution plotted in histogram
